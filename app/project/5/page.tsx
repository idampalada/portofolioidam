...
export default function ProjectDetail({ params }: PageProps) {
  const slides = [
    { type: "video", src: "/shortlink.mp4" },
    { type: "image", src: "/shortlink/halamanawal.png" },
    { type: "image", src: "/shortlink/home.png" },
    { type: "image", src: "/shortlink/dashboard.png" },
    { type: "image", src: "/shortlink/myurl.png" },
  ];
